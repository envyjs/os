...
const terminal = document.getElementById('terminal');
    ...
    const commands = {
      help: () => {
        createOutputLine("Envy Terminal, version v10.0.5473 (2027 Update)");
      ...
      uname: (args) => {
        if (args[0] === '-a') {
          return "Envy 10.0.5473 2027 Update Neutral Envy";
        } if (args[0] === '-r') {
          return "10.0.5473";
        } else {
          return "Envy";
      ...
      ver: () => {createOutputLine("Envy 2027 Update 10.0.5473");},
    ...
    createOutputLine("Envy [Version 10.0.5473]");
